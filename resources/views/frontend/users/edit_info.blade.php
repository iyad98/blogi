        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-12">
                    ...
                    {!! Form::open(['route' => 'users.info.update', 'name' => 'user_info', 'id' => 'user_info', 'method' => 'post', 'files' => true]) !!}
                    <div class="row">
                        <div class="col-3">
                    ...
                    <div class="row">
                        @if (auth()->user()->user_image != '')
                            <div class="col-12">
                                <img src="{{ url('/') }}/public/assets/users/{{auth()->user()->user_image}}" class="img-fluid" width="150" alt="{{ auth()->user()->name }}">
                            </div>
                        @endif
                        <div class="col-12">
                            <div class="form-group">
                    ...
                    {!! Form::open([ 'route' => 'users.password.update', 'name' => 'user_password', 'id' => 'user_password', 'method' => 'post']) !!}
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
