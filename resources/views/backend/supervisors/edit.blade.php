...
@section('style')
    <link rel="stylesheet" href="{{ url('/') }}/public/backend/vendor/select2/css/select2.min.css">
@endsection
@section('content')
            ...
            <div class="row pt-4">
                @if ($user->user_image != '')
                    <div class="col-12 text-center">
                        <div id="imgArea">
                            <img src="{{ url('/') }}/public/assets/users/{{$user->user_image}}" width="200" height="200">
                            <button style="margin-top: 15%" class="btn btn-danger removeImage "><i class="fa fa-trash"></i></button>
                        </div>
                    </div>
                @endif
                <div class="col-12">
...
@endsection
@section('script')
    <script src="{{ url('/') }}/public/backend/vendor/select2/js/select2.full.min.js"></script>
    <script>
        $(function () {
